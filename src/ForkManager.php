...
namespace Cityware\ParallelJobs;

use Cityware\ParallelJobs\Storage\Segment;
use Cityware\ParallelJobs\Storage\StorageInterface;
use Cityware\MemoryShared\MemorySharedManager;
use Cityware\MemoryShared\Storage;
...
class ForkManager {
     ...
     * @var string
     */
    protected $defaultResultsContainer = 'Cityware\ParallelJobs\Storage\Results\Results';

    /**
     * Default result container
     * @var string
     */
    protected $defaultResultContainer = 'Cityware\ParallelJobs\Storage\Result\Result';
